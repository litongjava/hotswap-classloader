...
public class SpringApplicationWrapper {
   ...
   * 
   */
  public static ConfigurableApplicationContext run(Class<?> clazz, String[] args, Boolean isDev) {
    if (isDev) {
      /**
       ...
       */
      return runDev(clazz, args, isDev);
   ...
   * @return
   */
  private static ConfigurableApplicationContext runDev(Class<?> clazz, String[] args, Boolean isDev) {
    ...
    ConfigurableApplicationContext context = (ConfigurableApplicationContext) ReflectionUtils.invoke(runMethod, clazz, args);
    ...
    ReflectionUtils.invoke(initMethod, clazz, args, context, isDev);
